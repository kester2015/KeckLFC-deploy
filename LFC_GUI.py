...
class MainWidget(QWidget):
    ...
    def rio_control_widget(self):
        widget = QGroupBox("RIO laser")
        layout = QGridLayout(widget)
        layout.addWidget(QLabel("Tset"))
    ...
    def setup_locking_widget(self):
        ...
        locking_layout.addWidget(self.srs_control_widget("FC_locking"))
        locking_layout.addWidget(self.srs_control_widget("IM_locking"))
        locking_layout.addWidget(self.srs_control_widget("LLC_locking"))
        return locking_widget

    def srs_control_widget(self, name): # srs: stanford research system, SIM960 module
