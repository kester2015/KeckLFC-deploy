...
class SRS_PIDcontrol_SIM960(object):
    ...
    def set_manual_output(self, num):
        ...
        self.__set_num_withcmd(
            ...
            decimal=None if self.__manual_output_resolution == None else int(-log10(self.__manual_output_resolution)))
    ...
    def __set_num_withcmd(self, cmd, num, printstr=None, low_lim=None, high_lim=None, decimal=None, clear=True):
        cmd = str(cmd).upper()
        num = float(num)
        if printstr == None:
            printstr = cmd
