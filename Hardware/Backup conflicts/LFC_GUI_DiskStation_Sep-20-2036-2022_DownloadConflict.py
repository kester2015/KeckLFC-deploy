...
class DeviceManager(object):
    def __init__(self,
        ...
        self.ptamp_addr, self.ptamp_name  = ptamp_addr, pt
        = 'Pritel'
        self.RFoscPS_addr = 'ASRL5::INSTR'
        self.RFoscPS_name = 'RF osc'
        self.RFampPS_addr = 'ASRL10::INSTR'
        self.RFampPS_name = 'RF amp',
        self.rbclock_addr = 'ASRL9::INSTR'
        self.rbclock_name = 'Rb Clock',
        self.wsp_addr = 'SN201904'
        self.wsp_name = "WS1",
        self.rio_addr = 'ASRL12::INSTR', 
        self.rio_name = 'RIO',
        self.FCtec_addr = 'ASRL18::INSTR', self.FCtec_name = 'FC tec',
        self.srs_addr = 'ASRL21::INSTR', self.srs_name = 'srs',
        self.osa_addr = 'GPIB0::1::INSTR',self.osa_name = 'Ando OSA'
