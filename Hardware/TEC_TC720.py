...
##NOTE: Maodong: This code is copied and adapted from Github:
# https://github.com/linnarsson-lab/Py_TC-720
# The original author is Lars E. Borm
# I have made some changes to make it compatible with the Device class in LFC.
...
class TEC_TC720(Device):
    ...
    """
    def __init__(self, addr='COM45', name = 'TC-720'):
                #  mode = 0, control_type = 0,
